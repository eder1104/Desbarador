...
<div class="container mx-auto px-4 mt-10">
    <h1 class="text-3xl font-bold text-center mb-6 text-blue-700">
        Conversor de Powerpoint
    </h1>

    <div class="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-xl">
        <p class="text-gray-600 mb-6 text-center">
            Sube tu archivo Powerpoint y selecciona el formato de destino para la conversión.
        </p>

        <form action="{{ route('documentos.convert.convertIndex', ['formato_origen' => 'powerpoint']) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-5">
                <label for="document_file" class="block text-sm font-medium text-gray-700 mb-2">
                    Seleccionar Archivo Powerpoint:
                </label>
                <input type="file" name="document_file" id="document_file" accept=".ppt,.pptx" required
