...
<div class="container mx-auto px-4 mt-10">
    ...
    <div class="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-xl">
        <p class="text-gray-600 mb-6 text-center">
            Sube tu archivo Excel y selecciona el formato de destino para la conversión.
        </p>

        <form action="{{ route('documentos.convert.convertIndex', ['formato_origen' => 'excel']) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-5">
                ...
                <input type="file" name="document_file" id="document_file" accept=".xls,.xlsx" required
