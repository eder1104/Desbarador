...
<div class="container mx-auto px-4 mt-10">
    ...
    <div class="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-xl">
        ...
        <form action="{{ route('plantillas.audio.convert.convertIndex', ['formato_origen' => 'alac']) }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="mb-5">
                <label for="audio_file" class="block text-sm font-medium text-gray-700 mb-2">
                    Seleccionar Archivo ALAC:
                </label>
                <input type="file" name="audio_file" id="audio_file" accept=".alac" required
