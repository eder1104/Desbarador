...
<div class="container mx-auto px-4 mt-10">
    ...
    <div class="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-xl">
        <p class="text-gray-600 mb-6 text-center">
            Sube tu archivo de audio WMA y selecciona el formato de destino para la conversión.
        </p>

        <form action="{{ route('plantillas.audio.convert.convertIndex', ['formato_origen' => 'wma']) }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="mb-5">
                <label for="audio_file" class="block text-sm font-medium text-gray-700 mb-2">
                    Seleccionar Archivo WMA:
                </label>
                <input type="file" name="audio_file" id="audio_file" accept=".wma" required
