...
<div class="container mx-auto px-4 mt-10">
    <h1 class="text-3xl font-bold text-center mb-6 text-blue-700">
        Conversor de WAV a otro formato
    </h1>

    <div class="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-xl">
        <p class="text-gray-600 mb-6 text-center">
            Sube tu archivo WAV y selecciona el formato de destino para la conversión.
        </p>

        <form action="{{ route('plantillas.audio.convert.convertIndex', ['formato_origen' => 'wav']) }}" method="POST" enctype="multipart/form-data">
            @csrf
